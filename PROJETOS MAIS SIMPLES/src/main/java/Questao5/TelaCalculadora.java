...
public class TelaCalculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        resultado.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(multip, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(multip, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (!currentText.isEmpty() && operador == null) {
            valor1 = Double.parseDouble(currentText);
            resultado.setText(currentText + " - ");
            operador = "subtracao";
            resultado.setText("");
        } else if (!currentText.isEmpty() && operador.equals("subtracao")) {
            ...
            switch (operador) {
                ...
                case "divisao":
                    if (valor2 != 0) {
                        ...
                        resultado.setText("Error: Divisao por zero");
                    }
                    break;
                case "elevado":
                ...
                default:
                    resultado.setText("Error: operador invalido");
                    break;
            }
        } catch (NumberFormatException e) {
            resultado.setText("Error: Invalid input");
            System.out.println("Erro ao converter para número: " + e.getMessage());
        }
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        ...
        try {
            double valorNumerico = Double.parseDouble(textoAtual);

            double valorFormatado = valorNumerico / 100.0;

            resultado.setText(String.valueOf(valorFormatado));
        } catch (NumberFormatException e) {
            resultado.setText("Clique em um numero");
        }
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        if (!currentText.isEmpty()) {
            ...
            if (valor1 >= 0) {
                ...
                resultado.setText("Error:numero negativo");
            }
        }
    }//GEN-LAST:event_jButton10ActionPerformed

    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        resultado.setText(String.valueOf(Math.PI));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (!currentText.isEmpty()) {
            ...
            if (valor > 0) {
                resultado.setText(String.valueOf(Math.log(valor)));
            } else {
                resultado.setText("Error");
            }
        } else {
